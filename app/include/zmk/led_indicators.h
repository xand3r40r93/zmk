...
#define ZMK_INDICATORS_NUMLOCK_BIT BIT(0)
#define ZMK_INDICATORS_CAPSLOCK_BIT BIT(1)
#define ZMK_INDICATORS_SCROLLLOCK_BIT BIT(2)
#define ZMK_INDICATORS_COMPOSE_BIT BIT(3)
#define ZMK_INDICATORS_KANA_BIT BIT(4)
